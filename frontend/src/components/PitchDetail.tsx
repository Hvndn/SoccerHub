...
export default function PitchDetail({
  ...
  return (
    <div className="w-full space-y-6 pb-24 animate-fade-in">
      {/* Navigation Header Bar with Back Button */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-4 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-md">
        <div className="flex items-center space-x-3">
          <button
            onClick={onBack}
            className="px-4 py-2.5 rounded-2xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-white font-extrabold text-xs transition-all flex items-center space-x-2 active:scale-95 shadow-xs"
          >
            <ArrowLeft className="w-4 h-4 text-pitch-emerald" />
          ...
          <div className="flex items-center space-x-2 text-xs font-semibold text-slate-500 dark:text-slate-400">
            ...
            <span className="text-pitch-emerald font-bold truncate max-w-[220px]">{venueData.name}</span>
          </div>
        </div>

        <div className="flex items-center space-x-2">
          <div className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-bold">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-lg space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-5 py-3 rounded-2xl bg-pitch-emerald hover:bg-pitch-darkEmerald text-white font-extrabold text-xs transition-all flex items-center space-x-2 shadow-md shadow-pitch-emerald/20 active:scale-95"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 rounded-3xl overflow-hidden pt-2">
          <div className="md:col-span-2 relative group overflow-hidden rounded-2xl h-72 md:h-96 border border-slate-200 dark:border-slate-800">
            <img
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent flex items-end p-6">
              <div className="space-y-1">
                ...
                <p className="text-white font-bold text-base">Thảm Cushion Acrylic 8 Lớp Chuẩn Giải Đấu USA</p>
              </div>
            </div>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-1 gap-3 h-72 md:h-96">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-lg space-y-6">
        ...
        <div className="border-b border-slate-200 dark:border-slate-800 flex space-x-6">
          <button
            ...
            className={`pb-4 font-extrabold text-sm border-b-2 transition-all flex items-center space-x-2 ${
              activeTab === "BOOKING"
              ...
              <div className="flex items-center space-x-2 overflow-x-auto w-full sm:w-auto no-scrollbar pb-1">
                {datesList.map((d) => (
                  <button
                    ...
                    className={`px-5 py-3 rounded-2xl border text-xs font-bold shrink-0 transition-all flex flex-col items-center min-w-[120px] ${
                      selectedDate === d.id
