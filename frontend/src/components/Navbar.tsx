...
export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 shadow-sm transition-colors duration-300">
      <div className="max-w-[1600px] mx-auto px-3 sm:px-8 lg:px-12 h-14 sm:h-16 flex items-center justify-between gap-2 sm:gap-4">
        {/* BRAND LOGO */}
        <div
        ...
        >
          ...
          <div className="flex items-center space-x-1">
            ...
            <span className="px-1.5 py-0.5 text-[8px] sm:text-[9px] font-black uppercase tracking-wider bg-[#0b4f6c] dark:bg-sky-500 text-white dark:text-slate-950 rounded-md shadow-xs">
              PRO
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-1.5 sm:space-x-2.5 shrink-0">
          ...
          <button
            type="button"
            onClick={toggleTheme}
            className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-sky-400 border border-slate-200 dark:border-slate-700/80 transition-all flex items-center justify-center shrink-0 active:scale-95"
          ...
          <div className="relative">
            <button
              ...
              className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 flex items-center justify-center border border-slate-200 dark:border-slate-700/80 transition-all"
            >
              <Bell className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              <span className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 w-2 h-2 rounded-full bg-emerald-500 ring-2 ring-white dark:ring-slate-900" />
            </button>

            {showNotifications && (
              <div className="absolute right-0 mt-2 w-72 sm:w-80 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 p-4 space-y-3 z-50 animate-modal-pop">
          ...
          {user ? (
            <div className="relative">
              <div
                ...
                className="flex items-center space-x-2 cursor-pointer pl-1 py-1 rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
              >
                ...
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#0b4f6c] dark:bg-sky-500 border-2 border-sky-400 text-white dark:text-slate-950 font-extrabold text-[11px] sm:text-xs flex items-center justify-center shrink-0 shadow-sm">
            ...
            <div className="flex items-center space-x-1.5 shrink-0">
              <button
                ...
                className="px-2.5 sm:px-3.5 py-1.5 sm:py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-900 font-extrabold text-[11px] sm:text-xs transition-all border border-slate-200 dark:bg-slate-800 dark:border-slate-700 dark:text-white flex items-center space-x-1 active:scale-95"
              >
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-t border-slate-200 dark:border-slate-800 py-1.5 px-3 flex items-center justify-around shadow-2xl">
        <button
          type="button"
          onClick={() => handleSelectSubTab("booking")}
          className={`px-3 py-1 rounded-xl flex flex-col items-center text-[10px] font-extrabold transition-all shrink-0 ${
            activeTab === "booking"
        ...
        >
          <Building className="w-4 h-4 mb-0.5 text-emerald-500" />
          <span>Khởi Tạo</span>
        </button>
